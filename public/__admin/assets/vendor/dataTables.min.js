  ...
  function ye(e, t) {
    ...
    if (l) {
      if (
        ...
        for (r = B("<tr/>").appendTo(l), n = 0, a = i.length; n < a; n++)
          B("<th/>")
            .html(i[n][s] || "")
            .appendTo(r);
      var u = Ce(e, l, !0);
  ...
  function ut(t, n) {
    return function (e) {
      return (
        y(e) ||
          "string" != typeof e ||
          ((e = e.replace(d, " ")), t && (e = I(e)), n && (e = R(e, !0))),
        e
      );
    };
  }
    ...
    gt =
      ...
      ($.defaults = {
        ...
        oLanguage: {
          ...
          sInfo: "Affichage de _START_ à _END_ sur _TOTAL_ _ENTRIES-TOTAL_",
          sInfoEmpty: "Affichage de 0 à 0 sur 0 _ENTRIES-TOTAL_",
          sInfoFiltered: "(filtré du total _MAX_ _ENTRIES-MAX_)",
          sInfoPostFix: "",
          sDecimal: "",
          sThousands: ",",
          sLengthMenu: "_MENU_",
