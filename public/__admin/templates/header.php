  ...
  <header style="z-index: 3;" :class="{'dark' : $store.app.semidark && $store.app.menu === 'horizontal'}">
      <div class="shadow-sm">
          <div class="relative flex w-full items-center bg-white px-5 py-2.5 dark:bg-[#0e1726]">
              <div class="horizontal-logo flex items-center justify-between ltr:mr-2 rtl:ml-2 lg:hidden">
                  <a href="index-2.html" class="main-logo flex shrink-0 items-center">
                      <img width="100" class="inline ltr:-ml-1 rtl:-mr-1" src="./../assets/images/logo/logo.png" alt="image" />
                  </a>
              ...
              <div x-data="header" class="flex items-center space-x-1.5 ltr:ml-auto rtl:mr-auto rtl:space-x-reverse dark:text-[#d0d2d6] sm:flex-1 ltr:sm:ml-0 sm:rtl:mr-0 lg:space-x-2">
                  ...
                  <div class="dropdown flex-shrink-0" x-data="dropdown" @click.outside="open = false">
                      <a href="javascript:;" class="group relative" @click="toggle()">
                          <span><img class="h-9 w-9 rounded-full object-cover saturate-50 group-hover:saturate-100" src="../_umedia/<?= $SiteInfo['logo']; ?>" alt="image" /></span>
                      </a>
                      <ul x-cloak x-show="open" x-transition x-transition.duration.300ms class="top-11 w-[230px] !py-0 font-semibold text-dark ltr:right-0 rtl:left-0 dark:text-white-dark dark:text-white-light/90">
                          <li>
                              <div class="flex items-center px-4 py-4">
                                  ...
                                  <div class="truncate ltr:pl-4 rtl:pr-4">
                                      ...
                                      <a class="text-black/60 hover:text-primary dark:text-dark-light/60 dark:hover:text-white" href="javascript:;"><?= $SiteInfo['login']; ?></a>
                                  </div>
                              </div>
                          </li>
                          ...
                          <div x-data="modal">
                              <li>
                                  <button type="button" class="dark:hover:text-white" @click="toggle">
                                  ...
                                  <div class="fixed inset-0 bg-[black]/60 z-[999] hidden overflow-y-auto" :class="open && '!block'">
                                      <div class="flex items-start justify-center min-h-screen px-4" @click.self="open = false">
                                          <div x-show="open" x-transition x-transition.duration.300 class="panel border-0 py-1 px-4 rounded-lg overflow-hidden w-full max-w-sm my-8">
                                              <div class="flex items-center justify-between p-5 font-semibold text-lg dark:text-white">Vos informations
                                              ...
                                              <div class="p-5">
                                                  <form method="post">
                                                      <div class="relative mb-4">
                                                          ...
                                                          <input type="text" value="<?= $SiteInfo['admin_nom']; ?>" name="admin_nom" placeholder="Name Complet" class="form-input ltr:pl-10 rtl:pr-10" />
                                                      </div>
                                                      <div class="relative mb-4">
                                                          <span class="absolute ltr:left-3 rtl:right-3 top-1/2 -translate-y-1/2 dark:text-white-dark">
                                                          ...
                                                          <input value="<?= $SiteInfo['login']; ?>" name="login" type="email" placeholder="Email" class="form-input ltr:pl-10 rtl:pr-10" />
                                                      </div>
                                                      <div class="relative mb-4">
                                                          <span class="absolute ltr:left-3 rtl:right-3 top-1/2 -translate-y-1/2 dark:text-white-dark">
                                                          ...
                                                          <input name="mdp" value="<?= $SiteInfo['mdp']; ?>" type="password" placeholder="Password" class="form-input ltr:pl-10 rtl:pr-10" />
                                                      </div>
                                                      <div class="grid grid-cols-2 gap-4">
                                                      <button type="button"  @click="toggle" class="btn btn-danger w-full">Annuler</button>
                                                      <button type="submit" name="submitUpdateInfo" class="btn btn-primary w-full">Valider</button>
                                                      </div>
                          ...
                          <li class="border-t border-white-light dark:border-white-light/10">
                              <a href="./quit" class="!py-3 text-danger" @click="toggle">
