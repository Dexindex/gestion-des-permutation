          ...
          <div class="relative flex w-full items-center bg-white px-5 py-2.5 dark:bg-[#0e1726]">
              <div class="horizontal-logo flex items-center justify-between ltr:mr-2 rtl:ml-2 lg:hidden">
                  <a href="index-2.html" class="main-logo flex shrink-0 items-center">
                      <img width="140" class="inline ltr:-ml-1 rtl:-mr-1" src="{{asset('images/logo.png')}}" alt="image" />
                  </a>
              ...
              <div x-data="header"
                  ...
                  <div>
                      <a href="javascript:;" x-cloak x-show="$store.app.theme === 'light'" href="javascript:;"
                          ...
                          x-on:click="$store.app.toggleTheme('dark')">
                          <svg width="20" height="20" viewBox="0 0 24 24" fill="none"
                              xmlns="http://www.w3.org/2000/svg">
                      ...
                      <a href="javascript:;" x-cloak x-show="$store.app.theme === 'dark'" href="javascript:;"
                          class="flex items-center rounded-full bg-white-light/40 p-2 hover:bg-white-light/90 hover:text-primary dark:bg-dark/40 dark:hover:bg-dark/60"
                          x-on:click="$store.app.toggleTheme('system')">
                          <svg width="20" height="20" viewBox="0 0 24 24" fill="none"
                              xmlns="http://www.w3.org/2000/svg">
                              <path
                      ...
                      <a href="javascript:;" x-cloak x-show="$store.app.theme === 'system'" href="javascript:;"
                          class="flex items-center rounded-full bg-white-light/40 p-2 hover:bg-white-light/90 hover:text-primary dark:bg-dark/40 dark:hover:bg-dark/60"
                          x-on:click="$store.app.toggleTheme('light')">
                          <svg width="20" height="20" viewBox="0 0 24 24" fill="none"
                              xmlns="http://www.w3.org/2000/svg">
                              <path
                  ...
                  <div class="dropdown flex-shrink-0" x-data="dropdown" x-on:click.outside="open = false">
                      <a href="javascript:;" class="group relative" x-on:click="toggle()">
                          <span><img class="h-9 w-9 rounded-full object-cover saturate-50 group-hover:saturate-100"
                                  src="{{asset("./storage/".$siteinfo->photo)}}" alt="image" /></span>
                      </a>
                      <ul x-cloak x-show="open" x-transition x-transition.duration.300ms
                          ...
                          <li>
                              <div class="flex items-center px-4 py-4">
                                  ...
                                  <div class="truncate ltr:pl-4 rtl:pr-4">
                                      <h4 class="text-base">
                                          {{ $siteinfo->nom . ' ' . $siteinfo->prenom }}
                                      </h4>
                                      <a class="text-black/60 hover:text-primary dark:text-dark-light/60 dark:hover:text-white"
                                          href="javascript:;">{{ $siteinfo->email }}</a>
                                  </div>
                              </div>
                          </li>
                          ...
                          <div x-data="modal">
                              <li>
                                  <button type="button" class="dark:hover:text-white" style="display: none" x-on:click="toggle">
                                  ...
                                  <div class="fixed inset-0 bg-[black]/60 z-[999] hidden overflow-y-auto"
                                      ...
                                      <div class="flex items-start justify-center min-h-screen px-4"
                                          ...
                                          <div x-show="open" x-transition x-transition.duration.300
                                              ...
                                              <div class="p-5">
                                                  <form method="post"
                                                      action="{{ route('formateur.update', $siteinfo->id) }}">
                                                      @method('PUT')
                                                      @csrf
                                                      ...
                                                      <div class="relative mb-4">
                                                          ...
                                                          <input type="text" value="{{ $siteinfo->nom }}"
                                                      ...
                                                      <div class="relative mb-4">
                                                          ...
                                                          <input type="text" value="{{ $siteinfo->prenom }}"
                                                              name="prenom" placeholder="Prénom Complet"
                                                              class="form-input ltr:pl-10 rtl:pr-10" />
                                                      </div>
                                                      <div class="relative mb-4">
                                                          <span
                                                          ...
                                                          <input value="{{ $siteinfo->email }}" disabled
                                                      ...
                                                      <div class="grid grid-cols-2 gap-4">
                                                          ...
                                                          <button type="submit"
                                                              class="btn btn-secondary w-full">Valider</button>
                                                      </div>
                                                  </form>
                          ...
                          <li class="border-t border-white-light dark:border-white-light/10">
                              <a href="{{ route('login.logout') }}" class="!py-3 text-danger" x-on:click="toggle">
