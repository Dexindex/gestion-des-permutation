...
<head>
    ...
    <title>Gestion Des Permutation | Login</title>
                ...
                <div
                    ...
                    <div
                        ...
                        <div class="mx-auto w-full max-w-[440px]" style="padding-left: 3rem;padding-right: 3rem">
                            ...
                            <form class="space-y-5 dark:text-white" action="{{ route('login.login') }}" method="post">
                                @csrf
                                <div>
                                    <label for="Email">Login</label>
                                    <div class="relative text-white-dark">
                                        <input id="Email" type="text" name="login" value="{{ old('login') }}"
